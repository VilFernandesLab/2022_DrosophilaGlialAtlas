...
dataE <- RenameIdents(object = dataE, `8` = "e_PNSg_3",`2` = "e_Unknown_1", 
                     ...
                     `7` = "e_Ensheathing",`9` = "e_Subperineurial",`10` = "e_MAP",
                     `6` = "e_PNSg_2",`4` = "e_Perineurial",`1` = "e_Cortex")
...
# Expression plot (DotPlot) for marker genes within each cluster (clean previous objects)
        ...
        data.subset.embryo <- subset(integrated, subset = NamesForIntegrationEmbryo == c("e_Perineurial","e_MAP","e_Subperineurial","e_Ensheathing", "e_Cortex","e_Astrocyte"))
        ...
        plotData.Combined$id <- factor(plotData.Combined$id, levels = rev(c("e_Perineurial","a_Perineurial", "e_MAP","a_Chalice",
